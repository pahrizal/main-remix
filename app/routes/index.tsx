            ...
            <div className="flex flex-col overflow-hidden items-center justify-center">
                ...
                <div className="flex w-full flex-col mt-8 items-center">
                    <div className="flex flex-row border border-lime-500 items-center sm:w-full">
                        ...
                        />
                        <p className="text-lime-500 font-virgil py-4 xl:text-xl lg:text-lg md:text-md text-sm">and</p>
                        <input
                            ref={playerNameRef}
                            maxLength={20}
                            value={playerName}
                    ...
                    <div
                        ...
                        className={clsx("sm:mr-0 xs:mr-0 xl:mr-4 lg:mr-4 md:mr-4 sm:w-full xs:w-full text-center mt-4")}
                    >
