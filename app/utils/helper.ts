...
export const printLog = (
    ...
    console.log(
        `[${TerminalColor.FgMagenta}${currentTimestamp() + TerminalColor.Reset}][${TerminalColor.FgCyan}${label}${
            TerminalColor.Reset
        }]`,
        color,
        ...message,
 ...
 */
export const preloadImage = async (imgPath: string): Promise<HTMLImageElement> =>
    new Promise((res) => {
