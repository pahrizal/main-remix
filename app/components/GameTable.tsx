...
const GameTable: React.FC<Props> = ({
    ...
    return (
        <div
            className={clsx("absolute z-0 inset-0 w-screen h-screen flex flex-col justify-center items-center", {
                blur: blur,
            })}
        >
            <div className="relative w-[95%] h-[70%] min-h-[320px] min-w-[640px] max-h-[480px] max-w-[1024px] bg-slate-700 rounded-[6rem] border-[1rem] table-shadow shadow-slate-100 border-slate-900 flex flex-col justify-center items-center">
                ...
                <div className="flex flex-col w-full">
                    <div id="info-message-container" className="flex w-full justify-center mb-4 items-center flex-row">
                        {hasFreeFold && (
                            <div id="freefold-info" className="text-white text-center flex-col">
                    ...
                    <div
                        id="table-cards"
                        style={{}}
                        className={clsx("flex w-full justify-center items-center flex-row", {
