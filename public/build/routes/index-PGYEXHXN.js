...
var RubberText = ({
  text = "",
  bounceIn,
  className = "font-virgil xl:text-7xl lg:text-6xl md:text-4xl sm:text-5xl xs:text-5xl hover:animate-rubber hover:text-lime-400 cursor-pointer"
}) => {
...
//# sourceMappingURL=/build/routes/index-PGYEXHXN.js.map
