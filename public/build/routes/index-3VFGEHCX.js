...
var RubberText = ({
  text = "",
  bounceIn,
  className = "font-virgil xl:text-7xl lg:text-5xl hover:animate-rubber hover:text-lime-400 cursor-pointer"
}) => {
...
//# sourceMappingURL=/build/routes/index-3VFGEHCX.js.map
