...
var RubberText = ({
  text = "",
  bounceIn,
  className = "font-virgil xl:text-7xl lg:text-5xl md:text-4xl sm:text-3xl hover:animate-rubber hover:text-lime-400 cursor-pointer"
}) => {
...
//# sourceMappingURL=/build/routes/index-DKN7F63Z.js.map
