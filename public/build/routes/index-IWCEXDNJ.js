...
var RubberText = ({
  ...
  bounceIn,
  rootClass = "",
  className = "font-virgil xl:text-7xl lg:text-6xl md:text-6xl text-4xl hover:animate-rubber hover:text-lime-400 cursor-pointer"
}) => {
...
//# sourceMappingURL=/build/routes/index-IWCEXDNJ.js.map
