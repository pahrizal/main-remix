...
function Index() {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", {
    ...
    className: "btn-anim-bg px-8 py-4 font-exo text-slate-100 xl:text-xl lg:text-lg md:text-md text-sm",
    ...
    className: "btn-anim-bg px-1 py-4 font-exo text-slate-100  xl:text-xl lg:text-lg md:text-md text-sm",
    onClick: handleJoin
...
//# sourceMappingURL=/build/routes/index-3RKHUBXR.js.map
