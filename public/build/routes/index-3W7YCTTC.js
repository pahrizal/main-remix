...
var RubberText = ({
  text = "",
  bounceIn,
  className = "font-virgil xl:text-7xl lg:text-6xl md:text-6xl  text-5xl hover:animate-rubber hover:text-lime-400 cursor-pointer"
}) => {
...
//# sourceMappingURL=/build/routes/index-3W7YCTTC.js.map
