...
var RubberText = ({
  text = "",
  bounceIn,
  className = "font-virgil text-7xl hover:rubber hover:text-lime-400 cursor-pointer"
}) => {
...
function Index() {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", {
    ...
    className: "h-100 bg-transparent outline-none px-4 text-lime-400 font-bold font-virgil",
    placeholder: "Enter game ID here",
    onChange: handleRoomInput
  }), /* @__PURE__ */ import_react2.default.createElement("button", {
    className: "px-8 py-4 font-virgil bg-lime-400 text-slate-900 text-xl hover:bg-lime-200 hover:rubber",
    onClick: handleJoin
  }, "Join"))));
}
export {
...
//# sourceMappingURL=/build/routes/index-3EWQYIW5.js.map
